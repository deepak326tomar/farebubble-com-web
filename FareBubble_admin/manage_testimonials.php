...
$button='button_add';
$button_title = 'Submit';	
$self = 'index.php?page=manage_testimonials';
$action="Add"; 
$id	='';
$title_name ='';
$general_info ='';
...
if($day=='today')
{
$self='index.php?page=manage_testimonials&day=today';	
...
{
$self='index.php?page=manage_testimonials&day=yesterday';		
...
$self='index.php?page=manage_testimonials&day=month';		
...
move_uploaded_file($_FILES['airline_image']['tmp_name'],$airline_image);
			...
			insert($conn,'tb_testimonials',$data);
...
{
	$id=$_REQUEST['id'];
	$tot_comp = totalrows($conn,"tb_testimonials","WHERE  "."title_name ='".trim(strtoupper($_POST['title_name']))."' and delete_status='False' and id!='$id'");
		$tot_comp='0';
		if($tot_comp > 0)
		{
			$button='button_add';
...
$manu_docc = selectfetch($conn,"airline_image","tb_testimonials","where id = '".$id."' ");
...
update($conn,"tb_testimonials",$data,"where id = '$id'");
...
/*********        DISPLAY VALUE WHEN WE EDIT ANY RECORD START     ****** **/
	if($action=='edit')
	{
		...
		$button_title = 'Update';
		$form_area = '';
		//$manu1 = selectfetch($conn,"*","tb_explore_packages","where id = '$id'");
		
		$manu=mysqli_fetch_assoc(mysqli_query($conn,"select * from tb_testimonials where id='$id'"));
		$id		=	$manu->id;
		$title_name		=	$manu['title_name'];
		
		$general_info		=	$manu['general_info'];
	...
	if($action=='del')
	{
		...
		if($tot_dist <=0 )
		{
			$data_delete = array(	'delete_date' =>$delete_date,
									...
									'delete_status' => 'True');
			update($conn,"tb_testimonials",$data_delete,"where id=".$id);
			$stat="4";
...
/*********       MULTIPLE ENABLED AND DISABLED STATUS END       ****** **/
	...
	$sqll = mysqli_query($conn,"select * From tb_testimonials where id!='' and delete_status='False' $d_query  order by id desc");	
...
<body class="fixed-top">
				...
				<div class="row-fluid" id="abc" <?php echo $form_area; ?>>
					 ...
					 <div class="span4">
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" name="title_name" placeholder="Enter  name" value="<?php echo $title_name; ?>" class="m-wrap width100" />
					...
					<div class="row-fluid">
                       ...
                       <div class="span12">
                        <div class="control-group">
                            <label class="control-label">Discretion</label>
                            <div class="controls">
                                <textarea  name="general_info" rows="4" cols="50" class=" m-wrap width100"  placeholder="Enter Discretion" ><?php echo $general_info; ?></textarea>
                            </div>
                        </div>
						</div>
						...
						<!-- <div class="span6">
                        <div class="control-group">
                            <label class="control-label">Things To Note</label>
                            <div class="controls">


                            
                                <textarea  name="things" rows="4" cols="50" class=" m-wrap width100"  placeholder="Enter Things To Note" ><?php echo $things; ?></textarea>
					...
					<div class="span12">
						...
						<div class="portlet box light-grey">
							<div class="portlet-title">
								<h4><i class="icon-globe"></i>Total Client Testimonials =<?=$tot_discount?></h4>
								<div class="tools">
								...
								<table class="table table-striped table-bordered table-hover" id="sample_1">
									<thead>
										<tr>
                                           ...
                                           <th class="hidden-480">Display image</th>
									...
									?>
										<tr class="odd gradeX">
                                            ...
                                            <td><?php echo $row['general_info']; ?></td>
  ...
  <td><?php 
											if($row['add_by']=='0'){ echo 'Admin'; }else{ echo getvalue($conn,"user_name","tbl_users","where user_id='".$row['add_by']."'"); } 
											?></td>                                       
...
<script>
		...
		function get_city(val)
		{
	        ...
	        success: function (result) {
	        	document.getElementById("city_id").innerHTML=result;
			}
