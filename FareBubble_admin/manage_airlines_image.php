...
$button='button_add';
$button_title = 'Submit';	
$self = 'index.php?page=manage_airlines_image';
$action="Add";
$id	='';
...
move_uploaded_file($_FILES['airline_image']['tmp_name'],$airline_image);
		...
		if(isset($stat))
			{
	echo '<script type="text/javascript">window.location="'.$self.'&stat='.$stat.'&page_type_id='.$_GET['page_type_id'].'";</script>';
			}
...
/*********       MULTIPLE ENABLED AND DISABLED STATUS END       ****** **/
	...
	$sqll = mysqli_query($conn,"select * From tb_page_images where id!='' and delete_status='False' and page_type_id='$page_type_id'");	
				...
				<div class="row-fluid" id="abc" <?php echo $form_area; ?>>
					<div class="span4">
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" name="title_name" placeholder="Image Title Name" style="width:100%;" value="<?php echo $title_name; ?>" class="m-wrap" required />
                             ...
                             <div class="control-group">
                            <label class="control-label">Select Airline Image</label>
                              ...
                              <div class="controls">
                                 <div class="fileupload fileupload-new" data-provides="fileupload">
                                    ...
                                    <div>
                                       <span class="btn btn-file"><span class="fileupload-new">Select Airline Image</span>
					...
					<div class="span12">
						...
						<div class="portlet box light-grey">
							<div class="portlet-title">
								<h4><i class="icon-globe"></i>Total Manage Airlines Image=<?=$tot_discount?></h4>
								<div class="tools">
								...
								<table class="table table-striped table-bordered table-hover" id="sample_1">
									...
									?>
										...
										<tr class="odd gradeX">
                                            ...
                                            <td>
											<a href="<?php echo  $self;?>&page_type_id=<?php echo $page_type_id; ?>&id=<?php echo $row['id']; ?>&val=<?php echo $row['status']; ?>&action=status"><img title="<?php echo  $row['status'];?>" src="assets/img/<?php  echo  $row['status'];?>.jpg" width="16" country="16" border="0" /></a>
											
                                            </td>
											<td >
												<a href="<?php echo  $self;?>&action=edit&page_type_id=<?php echo $page_type_id; ?>&id=<?php echo $row['id']; ?>"><img src="assets/img/pencil.jpg"/></a>
												&nbsp; 
												<a href="<?php echo  $self;?>&action=del&page_type_id=<?php echo $row['page_type_id']; ?>&id=<?php echo $row['id']; ?>"><img src="assets/img/cross.jpg"/></a>
											</td>
										</tr>
										<?php
									}
