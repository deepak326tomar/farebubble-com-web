...
if(isset($_POST['button_edit']) && ($_POST['button_edit']!=''))
{
	...
	$tot_comp = totalrows($conn,"tb_home_slider","WHERE  promo_code1 ='".trim(strtoupper($_POST['promo_code1']))."' and delete_status='False' and id!='$id'");
		if($tot_comp > 0)
		{
			$button='button_add';
			 $stat = '3';
...
$manu_docc = selectfetch($conn,"airline_image","tb_home_slider","where id = '".$id."' ");
					...
					<div class="span12">
						...
						<div class="portlet box light-grey">
							<div class="portlet-title">
								<h4><i class="icon-globe"></i>Total Slider Images=<?=$tot_discount?></h4>
								<div class="tools">
