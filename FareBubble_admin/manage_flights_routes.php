...
$button='button_add';
$button_title = 'Submit';	
$self = 'index.php?page=manage_flights_routes';
$action="Add";
$page_id	='';
$short_code ='';
$destinations_type ='';
...
if($day=='today')
{
$self='index.php?page=manage_flights_routes&day=today';	
...
{
echo $day;
$self='index.php?page=manage_flights_routes&day=yesterday';		
...
$self='index.php?page=manage_flights_routes&day=month';		
...
/*********       MULTIPLE ENABLED AND DISABLED STATUS END       ****** **/
	...
	$sqll = mysqli_query($conn,"select * From tb_pages where page_id!='' and delete_status='False' $d_query   and page_type_id='6' order by page_id desc");	
		...
		<!-- BEGIN PAGE -->
			...
			<div class="container-fluid">
				...
				<div class="row-fluid" id="abc" <?php echo $form_area; ?>>
                   ...
                   $count=mysqli_query($conn,"select * from lk_tb_page_type where  page_type_id='6' ");
	               ...
	               <option value="<?php echo $rows['page_type_id'];?>"><?php echo $rows['page_type_name'];?></option>
						...
						<div class="span4">
                        <div class="control-group">
                            <label class="control-label">Destination display Page Name</label>
                            <div class="controls">
					...
					<div class="span12">
						...
						<div class="portlet box light-grey">
							<div class="portlet-title">
								<h4><i class="icon-globe"></i>Total Manage Flight Type  Details=<?=$tot_discount?></h4>
								<div class="tools">
