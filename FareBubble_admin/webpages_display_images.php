...
$button='button_add';
$button_title = 'Submit';	
$self = 'index.php?page=webpages_display_images';
$action="Add";
 $id	='';
 $pages_id	='';
 $promo_code1	='';
...
if($day=='today')
{
$self='index.php?page=webpages_display_images&day=today';	
...
{
echo $day;
$self='index.php?page=webpages_display_images&day=yesterday';		
...
$self='index.php?page=webpages_display_images&day=month';		
...
move_uploaded_file($_FILES['airline_image']['tmp_name'],$airline_image);
			...
			$data=array(
						...
						'promo_code1' => $_POST['promo_code1'],
						'promo_code2' => $_POST['promo_code2'],
						'promo_code3'=>$_POST['promo_code3'],
	     	...
	     	insert($conn,'tb_web_display_images',$data);
...
if(isset($_POST['button_edit']) && ($_POST['button_edit']!=''))
{
	...
	$tot_comp = totalrows($conn,"tb_web_display_images","WHERE  promo_code1 ='".trim(strtoupper($_POST['promo_code1']))."' and delete_status='False' and id!='$id'");
		if($tot_comp > 0)
		{
			$button='button_add';
			 $stat = '3';
...
$manu_docc = selectfetch($conn,"airline_image","tb_web_display_images","where id = '".$id."' ");
...
$airline_image=$old_airline_image;
	...
	update($conn,"tb_web_display_images",$data,"where id = '$id'");
	$stat = '2';
...
/*********        DISPLAY VALUE WHEN WE EDIT ANY RECORD START     ****** **/
	if($action=='edit')
	{
		...
		$button_title = 'Update';
		$form_area = '';
		$manu = selectfetch($conn,"*","tb_web_display_images","where id = '$id'");
	
		$id		=	$manu->id;
		$pages_id		=	$manu->pages_id;
		$promo_code1		=	$manu->promo_code1;
		$promo_code2		=	$manu->promo_code2;
		$promo_code3        = $manu->promo_code3;
...
/*********        DELETE SINGLE START     ****** **/
	if($action=='del')
	{
		...
		if($tot_dist <=0 )
		{
			...
			update($conn,"tb_web_display_images",$data_delete,"where id=".$id);
			$stat="4";
		...
		if($val == 'Enabled')
		{
			$new_val = 'Disabled';
				$data = array('status'=>$new_val,
							  'update_date'=>$update_date,
							  'update_by'=>$_SESSION['user_id']);
				update($conn,"tb_web_display_images
",$data,"WHERE id ='".$id."'");
				save_action_history($conn,"2",$id);
				$stat='2';
			}
...
$sqll = mysqli_query($conn,"select a.* ,b.page_name	 from  tb_web_display_images a  inner join tb_sco_pages b on a.pages_id=b.id where a.delete_status='False' $d_query  order by a.id asc");	
			...
			<div class="container-fluid">
				...
				<div class="row-fluid" id="abc" <?php echo $form_area; ?>>
					...
					<div class="span4">
					  ...
					  <div class="span4">
                        <div class="control-group">
                            <label class="control-label">title Name 1</label>
                            <div class="controls">
                                
                               <input type="text" name="promo_code1" placeholder="title Name 1" value="<?php echo $promo_code1; ?>" class="m-wrap width100" required/>
                            </div>
                        </div>
						</div>
                       </div>
					   <div class="row-fluid">
						<div class="span4">
                        <div class="control-group">
                            <label class="control-label">title Name 2</label>
                            <div class="controls">
                                <input type="text" name="promo_code2" placeholder="title Name 2" value="<?php echo $promo_code2; ?>" class="m-wrap width100" required/>
                         ...
                         <div class="span4">
                        <div class="control-group">
                            <label class="control-label">title Name 3</label>
                            <div class="controls">
                                <input type="text" name="promo_code3" placeholder="title Name 3" value="<?php echo $promo_code3; ?>" class="m-wrap width100" required/>
					...
					<div class="span12">
						...
						<div class="portlet box light-grey">
							<div class="portlet-title">
								<h4><i class="icon-globe"></i>Total Web display Pages Images=<?=$tot_discount?></h4>
								<div class="tools">
								...
								<table class="table table-striped table-bordered table-hover" id="sample_1">
									...
									?>
										<tr class="odd gradeX">
                                           ...
                                           <td><?php echo $row['promo_code1']; ?></td>
											<td><?php echo $row['promo_code2']; ?></td>
											<td><?php echo $row['promo_code3']; ?></td>
