...
$button='button_add';
$button_title = 'Submit';	
$self = 'index.php?page=destination_airlines_img';
$action="Add";
$id	='';
...
move_uploaded_file($_FILES['airline_image']['tmp_name'],$airline_image);
			...
			insert($conn,'tb_destination_airlines_img',$data);
...
$manu_docc = selectfetch($conn,"airline_image","tb_destination_airlines_img","where id = '".$id."' ");
...
$airline_image=$old_airline_image;
	...
	update($conn,"tb_destination_airlines_img",$data,"where id = '$id'");
	$stat = '2';
...
/*********        DISPLAY VALUE WHEN WE EDIT ANY RECORD START     ****** **/
	if($action=='edit')
	{
		...
		$button_title = 'Update';
		$form_area = '';
		$manu = selectfetch($conn,"*","tb_destination_airlines_img","where id = '$id'");
...
/*********        DELETE SINGLE START     ****** **/
	if($action=='del')
	{
		...
		if($tot_dist <=0 )
		{
			...
			update($conn,"tb_destination_airlines_img",$data_delete,"where id=".$id);
			$stat="4";
		...
		if($val == 'Enabled')
		{
			$new_val = 'Disabled';
				$data = array('status'=>$new_val,
							  'update_date'=>$update_date,
							  'update_by'=>$_SESSION['user_id']);
				update($conn,"tb_destination_airlines_img
",$data,"WHERE id ='".$id."'");
...
/*********       MULTIPLE ENABLED AND DISABLED STATUS END       ****** **/
	...
	$sqll = mysqli_query($conn,"select * From tb_destination_airlines_img where id!='' and delete_status='False' and page_id='$page_id'");	
				...
				<div class="row-fluid" id="abc" <?php echo $form_area; ?>>
					...
					<div class="span4">
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" name="promo_code1" placeholder="title Name 1" style="width:100%;" value="<?php echo $promo_code1; ?>" class="m-wrap" required />
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" name="promo_code2" placeholder="title Name 2" style="width:100%;" value="<?php echo $promo_code2; ?>" class="m-wrap"  />
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" name="promo_code3" placeholder="title Name 3" style="width:100%;" value="<?php echo $promo_code3; ?>" class="m-wrap"  />
					  ...
					  <div class="span3">
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" name="alt" placeholder="alt" value="<?php echo $alt;?>" class="m-wrap width100" required/>
					...
					<div class="span12">
						...
						<div class="portlet box light-grey">
							<div class="portlet-title">
								<h4><i class="icon-globe"></i>Total Manage Display Image=<?=$tot_discount?></h4>
								<div class="tools">
