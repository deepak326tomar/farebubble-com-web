...
$button='button_add';
$button_title = 'Submit';	
$self = 'index.php?page=privacy_policy';
$action="Add";
$page_id	='';
 $title_name  ='';
 $sub_title  ='';
...
insert($conn,'tb_privacy_policy',$data);
...
$manu_docc = selectfetch($conn,"title_name","tb_privacy_policy","where id = '".$id."' ");
	...
	update($conn,"tb_privacy_policy",$data,"where id = '$id'");
	$stat = '2';
...
/*********        DISPLAY VALUE WHEN WE EDIT ANY RECORD START     ****** **/
	if($action=='edit')
	{
		...
		$button_title = 'Update';
		$form_area = '';
		$manu = selectfetch($conn,"*","tb_privacy_policy","where id = '$id'");
		$id		=	$manu->id;
...
/*********        DELETE SINGLE START     ****** **/
	if($action=='del')
	{
		...
		if($tot_dist <=0 )
		{
			...
			update($conn,"tb_privacy_policy",$data_delete,"where id=".$id);
			$stat="4";
...
/*********       MULTIPLE ENABLED AND DISABLED STATUS END       ****** **/
	...
	$sqll = mysqli_query($conn,"select * From tb_privacy_policy where delete_status='False'  order by id desc");	
			...
			<div class="container-fluid">
				...
				<div class="row-fluid" id="abc" <?php echo $form_area; ?>>
					<div class="row-fluid">
						...
						<div class="span6">
                        <div class="control-group">
                            <label class="control-label">Sub Title Name</label>
                            <div class="controls">
					...
					<div class="span12">
						...
						<div class="portlet box light-grey">
							<div class="portlet-title">
								<h4><i class="icon-globe"></i>Total Manage Privacy Policy Details=<?=$tot_discount?></h4>
								<div class="tools">
