...
$button='button_add';
$button_title = 'Submit';	
$self = 'index.php?page=manage_global_details';
$action="Add";
$id	='';
...
if($day=='today')
{
$self='index.php?page=manage_global_details&day=today';	
...
{
echo $day;
$self='index.php?page=manage_global_details&day=yesterday';		
...
$self='index.php?page=manage_global_details&day=month';		
...
if((isset($_REQUEST['contact_address_line1']) && $_REQUEST['contact_address_line1']!=''))
	{
...
move_uploaded_file($_FILES['airline_image']['tmp_name'],$airline_image);
			...
			$data=array(
						'contact_address_line1' =>  $_POST['contact_address_line1'],

						'contact_address_line2' =>  $_POST['contact_address_line2'],
	     	...
	     	insert($conn,'tb_global_details',$data);
...
if(isset($_POST['button_edit']) && ($_POST['button_edit']!=''))
{
	...
	$tot_comp = totalrows($conn,"tb_global_details","WHERE  contact_address_line1 ='".trim(strtoupper($_POST['contact_address_line1']))."' and delete_status='False' and id!='$id'");
		if($tot_comp > 0)
		{
			$button='button_add';
			 $stat = '3';
...
$manu_docc = selectfetch($conn,"airline_image","tb_global_details","where id = '".$id."' ");
...
$airline_image=$old_airline_image;
	...
	$data=array(
					 ...
					 'contact_address_line1' =>  $_POST['contact_address_line1'],
						...
						'email' => $_POST['email'],
					     ...
					     'fa_google_plus' => $_POST['fa_google_plus'],
						 
						 'fa_facebook' => $_POST['fa_facebook'],
						 
						 'fa_twitter' => $_POST['fa_twitter'],
						 
						 'fa_instagram' => $_POST['fa_instagram'],
	...
	update($conn,"tb_global_details",$data,"where id = '$id'");
	$stat = '2';
...
/*********        DISPLAY VALUE WHEN WE EDIT ANY RECORD START     ****** **/
	if($action=='edit')
	{
		...
		$button_title = 'Update';
		$form_area = '';
		$manu = selectfetch($conn,"*","tb_global_details","where id = '$id'");
	
		$id		=	$manu->id;
		$contact_address_line1		=	$manu->contact_address_line1;
		
		$contact_address_line2		=	$manu->contact_address_line2;
		
		$toll_free_number           =   $manu->toll_free_number;
		
		$email           =   $manu->email;
		
		$fa_google_plus           =   $manu->fa_google_plus;
		$fa_facebook           =   $manu->fa_facebook;
		$fa_twitter           =   $manu->fa_twitter;
		$fa_instagram           =   $manu->fa_instagram;
		
		$promo_code           =   $manu->promo_code;
...
/*********        DELETE SINGLE START     ****** **/
	if($action=='del')
	{
		...
		if($tot_dist <=0 )
		{
			...
			update($conn,"tb_global_details",$data_delete,"where id=".$id);
			$stat="4";
...
/*********       MULTIPLE ENABLED AND DISABLED STATUS END       ****** **/
	...
	$sqll = mysqli_query($conn,"select * From tb_global_details where id!='' and delete_status='False' $d_query  order by id desc");	
				...
				<div class="row-fluid" id="abc" <?php echo $form_area; ?>>
					<div class="row-fluid">
                        ...
                        <div class="control-group">
                            <label class="control-label">Contact Address Line 1</label>
                            <div class="controls">
                                <input type="text" name="contact_address_line1" placeholder="Contact Address Line 1" width="245px" value="<?php echo $contact_address_line1; ?>" class="m-wrap" />
						...
						<div class="span3">
                        <div class="control-group">
                            <label class="control-label">Contact Address Line 2</label>
                            <div class="controls">
                                <input type="text" name="contact_address_line2" placeholder="Contact Address Line 2" width="245px" value="<?php echo $contact_address_line2; ?>" class="m-wrap" />
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" name="toll_free_number" placeholder="Toll Free Number" width="245px" value="<?php echo $toll_free_number; ?>" class="m-wrap" />
                    ...
                    <div class="span3">
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="email" name="email" placeholder="Email" width="245px" value="<?php echo $email; ?>" class="m-wrap" />
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" name="fa_google_plus" placeholder="google plus" width="245px" value="<?php echo $fa_google_plus; ?>" class="m-wrap" />
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" name="fa_facebook" placeholder="facebook" width="245px" value="<?php echo $fa_facebook; ?>" class="m-wrap" />
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" name="fa_twitter" placeholder="twitter" width="245px" value="<?php echo $fa_twitter; ?>" class="m-wrap" />
                    ...
                    <div class="span3">
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" name="fa_instagram" placeholder="Instagram" width="245px" value="<?php echo $fa_instagram; ?>" class="m-wrap" />
						...
						<div class="span3">	                 
                                    ...
                                    <div class="control-group">
                            <label class="control-label">Select Logo Image</label>
                              ...
                              <div class="controls">
                                 <div class="fileupload fileupload-new" data-provides="fileupload">
                                    ...
                                    <div>
                                       <span class="btn btn-file"><span class="fileupload-new">Select Logo Image</span>
                      ...
                      <div class="span3">
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" name="promo_code" placeholder="alt tag" width="245px" value="<?php echo $promo_code; ?>" class="m-wrap" />
					...
					<div class="span12">
						...
						<div class="portlet box light-grey">
							<div class="portlet-title">
								<h4><i class="icon-globe"></i>Total Global Details=<?=$tot_discount?></h4>
								<div class="tools">
								...
								<table class="table table-striped table-bordered table-hover" id="sample_1">
									<thead>
										<tr>
											...
											<th>Contact Address Line1 </th>
	                                        <th>Contact Address Line2 </th>
									...
									?>
										<tr class="odd gradeX">
                                            ...
                                            <td><?php echo $row['contact_address_line1']; ?></td>
											
											 <td><?php echo $row['contact_address_line2']; ?></td>
											 
											 <td><?php echo $row['toll_free_number']; ?></td>
