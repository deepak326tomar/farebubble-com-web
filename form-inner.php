                                                    ...
                                                    <div class="col-sm-12">
                                                        <div class="flight_type col-12">
                                                            <div class="form-check-inline">
                                                              ...
                                                              <div class="way-box">
                                                                  <label class="radio-inline checkbox text-white">Round Trip
                                                               ...
                                                               <div class="way-box">
                                                                  <label class="radio-inline checkbox text-white">One Way
...
<div class="pass_bx row pb-2 pt-2 border-bottom">
<div class="col-6">
  <label class="trav-span">Child <small>(0-17 yrs)</small></label>
</div>
<div class="col-6">
  <div class="count-input space-bottom qty text-right">
...
<button type="button" onclick="all_pesenger();" class="btn_done apply">Done</button>
                                                        ...
                                                        <button type="sumit" name="submitForm" class="search">Search</button>
                                                    </div>
                                                    </div>
...
<input type="text" id="ChildrenRT_2" class="form-control text-center add_num" name="ChildrenRT_2" value="0">
    ...
    function car_form()
    {
var from=document.getElementById("pickuploc").value;
document.getElementById("pickuploc").value=from.substring(0,3);
var droploc=document.getElementById("droploc").value;
document.getElementById("droploc").value=droploc.substring(0,3);
return true;
    }
